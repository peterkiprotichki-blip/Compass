    ...
    <div class="min-h-screen bg-ivory">
              ...
              <div class="relative w-full max-w-md bg-forest-deep/90 border border-forest-line rounded-sheet p-8 shadow-2xl backdrop-blur-sm">
                ...
                <div class="flex items-center justify-between border-b border-forest-line pb-4 mb-6">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <h4 class="font-serif font-bold text-ivory text-base">Business Pathfinder</h4>
                      <p class="text-xs text-gold">22 Questions · 15 Strengths</p>
                    </div>
                  </div>
                ...
                <div class="space-y-4">
                  <div class="flex items-center justify-between bg-forest p-4 rounded-card border border-forest-line">
                    <div>
                      <span class="text-xs text-ivory/60 uppercase font-semibold tracking-wider">Example Archetype</span>
                      <p class="font-serif font-bold text-lg text-ivory">The Seller</p>
                      <p class="text-xs text-gold mt-0.5">Sales · Communication · Network</p>
                    </div>
                  ...
                  <div class="p-3.5 bg-ivory/5 rounded-card text-xs text-ivory/70 space-y-1.5 border border-forest-line/50">
                    <p class="font-semibold text-gold">Matched Opportunities:</p>
                    <p class="flex items-center justify-between">
                      <span>1. Perfume & Fragrance Hub</span>
                      <span class="text-emerald-400 font-bold">96% Match</span>
                    </p>
                    <p class="flex items-center justify-between">
                      <span>2. Curated Mitumba Boutique</span>
                      <span class="text-emerald-400 font-bold">92% Match</span>
                    </p>
                  </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div class="p-3">
              ...
              <p class="text-xs sm:text-sm text-ivory/70 mt-1 uppercase tracking-wider font-semibold">Entrepreneurs Guided</p>
            </div>

            <div class="p-3 border-l border-forest-line/40">
              <p class="font-serif text-3xl sm:text-4xl font-bold text-gold">30+</p>
              <p class="text-xs sm:text-sm text-ivory/70 mt-1 uppercase tracking-wider font-semibold">African Business Models</p>
            </div>

            <div class="p-3 border-l border-forest-line/40">
              <p class="font-serif text-3xl sm:text-4xl font-bold text-gold">2</p>
              <p class="text-xs sm:text-sm text-ivory/70 mt-1 uppercase tracking-wider font-semibold">Languages (EN | SW)</p>
            </div>

            <div class="p-3 border-l border-forest-line/40">
              <p class="font-serif text-3xl sm:text-4xl font-bold text-gold">1 Goal</p>
              <p class="text-xs sm:text-sm text-ivory/70 mt-1 uppercase tracking-wider font-semibold">A Brighter Africa</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div class="bg-white rounded-sheet p-8 border border-forest-line/15 shadow-light-lg hover:border-gold transition-all duration-300 flex flex-col justify-between group">
            <div class="space-y-4">
              ...
              <div class="space-y-2 pt-2 text-xs font-semibold text-charcoal/80">
                <p class="flex items-center gap-2">✓ Discovers your Entrepreneur Archetype</p>
                <p class="flex items-center gap-2">✓ Computes your 100-point Business Readiness Score</p>
                <p class="flex items-center gap-2">✓ Top 3 Matched businesses with 30-day action plans</p>
              </div>
            </div>
            ...
            <div class="pt-8">
              ...
              >
                <span>Launch Business Pathfinder</span>
          ...
          <div class="bg-white rounded-sheet p-8 border border-forest-line/15 shadow-light-lg hover:border-forest transition-all duration-300 flex flex-col justify-between group">
            <div class="space-y-4">
              ...
              <div class="space-y-2 pt-2 text-xs font-semibold text-charcoal/80">
                <p class="flex items-center gap-2">✓ Cash flow and pricing leakage diagnostics</p>
                <p class="flex items-center gap-2">✓ Customer acquisition & retention playbooks</p>
                <p class="flex items-center gap-2">✓ Working capital and inventory turn optimization</p>
              </div>
            </div>
      ...
      <section class="py-20 bg-ivory-sunk border-y border-forest-line/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="text-center max-w-3xl mx-auto mb-16">
            <span class="text-xs font-semibold text-gold uppercase tracking-widest">Process</span>
            <h2 class="text-3xl sm:text-4xl font-serif font-bold text-charcoal mt-2">
              How Compass Works
            </h2>
            <p class="text-charcoal/70 text-base mt-2">A simple, powerful methodology from confusion to action.</p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-card p-6 border border-forest-line/10 shadow-light-sm space-y-3">
              ...
              <h4 class="font-serif font-bold text-lg text-charcoal">Tell us about you</h4>
            ...
            <div class="bg-white rounded-card p-6 border border-forest-line/10 shadow-light-sm space-y-3">
              ...
              <h4 class="font-serif font-bold text-lg text-charcoal">Get personalised insights</h4>
              <p class="text-xs text-charcoal/70 leading-relaxed">
            ...
            <div class="bg-white rounded-card p-6 border border-forest-line/10 shadow-light-sm space-y-3">
              ...
              <h4 class="font-serif font-bold text-lg text-charcoal">Take concrete action</h4>
              <p class="text-xs text-charcoal/70 leading-relaxed">
            ...
            <div class="bg-white rounded-card p-6 border border-forest-line/10 shadow-light-sm space-y-3">
              ...
              <h4 class="font-serif font-bold text-lg text-charcoal">Build and grow</h4>
              <p class="text-xs text-charcoal/70 leading-relaxed">
      ...
      <section class="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        <h3 class="text-2xl sm:text-3xl font-serif font-bold text-charcoal">
          Join a growing community of African entrepreneurs.
        </h3>
